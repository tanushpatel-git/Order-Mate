    ...
    const handleOrderData = (data) => {
     ...
     return (<div
        ...
        {foods.map((food, index) => (<div
            key={index}
            className="w-full max-w-sm relative top-[13vh] rounded-2xl shadow-xl bg-white/80 backdrop-blur-xl overflow-hidden transform transition hover:-translate-y-2 hover:shadow-2xl duration-300"
        >
            <div
            ...
            <div className="p-5 space-y-4">
                ...
                <div className="flex items-center justify-between">
                    ...
                    <button
                        onClick={()=>{handleOrderData(food)}}
                        className="rounded-xl px-5 py-2 font-medium bg-orange-500 hover:bg-orange-600 transition text-white shadow-md flex items-center gap-2 active:scale-95"
                    >
                        <svg
                        ...
                        >
                            <path
                                ...
                                d="M2.25 3h1.386c.51 0 .955.343 1.087.835l.383 1.437M7.5 14.25h11.218c.51 0 .955-.342 1.087-.834l1.716-6.45a.563.563 0 00-.546-.716H5.108m2.392 8.5a1.5 1.5 0 11-3 0m14.25 0a1.5 1.5 0 11-3 0"
                            />
                        </svg>
                        Make Order
                    </button>
